...
CREATE TABLE `useraccounts` (
  ...
  `ID User Account` int unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID User Account`),
  UNIQUE KEY `ID User Account_UNIQUE` (`ID User Account`),
...
INSERT INTO `useraccounts` VALUES ('ROOT','ROOT','ROOT','ROOT',4);
